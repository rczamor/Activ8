// $Id: script.js,v 1.1.2.6 2011/01/01 23:17:00 zfactor Exp $

Drupal.behaviors.activ8Equalheights = function (context) {
...
Drupal.behaviors.activ8IE6fixes = function (context) {
...
Drupal.behaviors.activ8Overlabel = function (context) {
  if (jQuery().overlabel) {
    $("div.activ8-horiz-login label").overlabel();
  }
};

Drupal.behaviors.activ8Superfish = function (context) {
...
Drupal.behaviors.activ8SuperfishBlocks = function (context) {
...
Drupal.behaviors.activ8GridMask = function (context) {
...
Drupal.behaviors.activ8GridMaskToggle = function (context) {
  if ($('body.grid-mask-enabled').size() > 0) {
...
Drupal.behaviors.activ8PanelsShowEdit = function (context) {
...
Drupal.behaviors.activ8Screenshotpreview = function (context) {
